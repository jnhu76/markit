...
fn main() -> io::Result<()> {
    let out_path = std::env::args()
        .nth(1)
        .unwrap_or_else(|| "protocol/result-schema-v1.json".to_string());
